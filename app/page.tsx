            ...
            {earlyAccessSubmitted ? (
              ...
              <>
                ...
                <form onSubmit={handleEarlyAccessSubmit}>
                  ...
                  <button type="submit" disabled={!earlyAccessForm.name || !earlyAccessForm.email || earlyAccessSubmitting} style={{ width: '100%', padding: '14px', borderRadius: 12, backgroundColor: earlyAccessForm.name && earlyAccessForm.email ? '#F7931A' : '#2A2A3A', color: '#fff', fontWeight: 700, fontSize: 15, border: 'none', cursor: 'pointer' }}>
