    ...
    <main className="min-h-screen" style={{ backgroundColor: '#0A0A0F' }}>
      ...
      <div className="px-6 pb-16 max-w-6xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div>
            <div className="w-full rounded-xl overflow-hidden flex items-center justify-center mb-4" style={{ backgroundColor: '#13131A', border: '1px solid #2A2A3A', aspectRatio: '4/3' }}>
              {listing.photos && listing.photos.length > 0 ? (
                <img src={listing.photos[selectedPhoto]} alt={listing.title} className="w-full h-full" style={{ objectFit: 'contain', maxHeight: '500px' }} />
              ) : (
